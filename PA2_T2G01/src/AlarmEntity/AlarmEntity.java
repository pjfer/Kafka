...
/**
 * Entidade que representa os Alarmes, gera três consumidores kafka com
 * group.id 0 que subrescrevem o tópico AlarmTopic.
 * 
...
public class AlarmEntity {
    ...
    public static void main(String[] args) throws IOException {
        ...
        /* 
            ...
            e os alarmes que são gerados.
        */
        AlarmGUI gui = new AlarmGUI();
        gui.startGUI(gui);
        
        /* Cria um ficheiro que guarda os alarmes gerados. */
